                ...
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            @endif
                            <form class="form form-horizontal" action="{{route('admins.update')}}" method="post"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="firstname"
                                                           class="form-control border-primary" value="{{$user->firstname}}" placeholder="First Name"
                                                           name="firstname">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" id="lastname" value="{{$user->lastname}}" class="form-control border-primary"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control border-primary" value="{{$user->email}}"  type="email"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control border-primary" value="{{$user->phone}}" type="tel"
                                                           placeholder="Contact Number" id="phone" name="phone">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control border-primary" type="password"
                                                           placeholder="Contact Number" id="password" name="password"
                                                           >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="userinput8">Roles
                                                    Users</label>
                                                <div class="col-md-9">
                                                    <select name="roles" id="" required
                                                            class="form-control border-primary" multiple>
                                                        @foreach($roles as $role)
                                                            <option value="{{$role}}" {{$role == $userRole ? 'selected' : null}}>{{$role}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
