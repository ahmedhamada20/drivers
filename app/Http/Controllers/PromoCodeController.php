...
class PromoCodeController extends Controller
{
    ...
    {
        $this->middleware('permission:PromoCode-list', ['only' => ['create']]);
        $this->middleware('permission:PromoCode-create', ['only' => ['store']]);
        $this->middleware('permission:PromoCode-edit', ['only' => ['edit']]);
