...
class DriverController extends Controller
{
        ...
        try {
            ...
            if (isset($checkDriver)) {
                ...
                if (isset($acceptOrder)) {
                    ...
                    $orderStatus->update([
                        'status' => "Driver assigned",
                        'total_amount' => $orderStatus->total_amount - $request->offer,
                    ]);
                    Log::info("api --acceptOrder -- updated successfully " . $acceptOrder->id);
                    $response = array(
                        "order_id" => $acceptOrder->order_id,
    ...
    //         $data['address'] = $request->address;
    //         // $data['profile'] = $profilenametostore;
    //         $data['emirates_id'] = $request->emirates_id;
    //         $data['distance'] = $request->distance;
    //         // $data['password'] = $request->password ? bcrypt($request->password) : "";
    //         // $data['licence_file'] = rtrim($licenseFileName, ',');
    //         $data->save();
    ...
    //         // if(isset($vehicles)){
    //         //     // $vehicles->file_path = ,
    //         //     $vehicles->model = $request->model ?  $request->model: $vehicles->model;
    //         //     $vehicles->type = $request->vehicle_type ? $request->vehicle_type : $vehicles->type;
    //         //     $vehicles->vehicle_number = $request->vehicle_number ? $request->vehicle_number : $vehicles->vehicle_number;
    //         //     $vehicles->save();
    //         // }else{
